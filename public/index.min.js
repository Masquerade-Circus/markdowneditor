(function () {
	...
	var Service$1 = {
	    ...
	    init: function init() {
	        for (var i in Service$1.locales) {
	            timeago_min.register(i, Service$1.locales[i]);
	        }
	...
	var Page$1 = {
	    ...
	    loading: true,
	    interval: setInterval(function () { return Page$1.save(); }, 5000),
	    isShared: false,
	    save: function save() {
	        if (
	            Page$1.document
	        ...
	        if (Page$1.isShared) {
	            return [
	                m('h1', [
	                    ...
	                    ' ',
	                    m('small', 'La última modificación se realizó ' + SERVICE.Timeago.format(Page$1.document.modifiedAt))
	                ]),
	                m('nav', [
	                    /* !Page.isOwner
	                        ? ''
	        ...
	        return [
	            m('textarea[data-background="default 100"]', {
	                oninput: function oninput(e) {
	                    ...
	                    Page$1.document.code = e.target.value;
	                    Page$1.document.isModified = true;
	                },
