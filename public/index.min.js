(function () {
	...
	var Service = {
	    isValid: function isValid(document) {
	...
	var Component$1 = {
	    ...
	    open: function open(options) {
	        ...
	        Component$1.closeAfter = options.closeAfter || 5;
	...
	var Page = {
	    ...
	    loading: true,
	    interval: setInterval(function () { return Page.save(); }, 5000),
	    save: function save() {
	        if (
